...
info = {
 ...
 'binary_name'              : 'espruino_%v_esp32_kb.bin',
 'build' : {
   'optimizeflags' : '-Og',
   'libraries' : [
     'ESP32',
   ...
   'makefile' : [
     ...
     'INCLUDE += -I$(ROOT)/libs/kb',
     'WRAPPERSOURCES += libs/kb/jswrap_kb.c'
   ]
 }
};
...
devices = {
  'BTN1' : { 'pin' : 'D16', 'pinstate' : 'IN_PULLDOWN' }, # 'P0_17' -  Pin negated in software
  'BTN2' : { 'pin' : 'D14', 'pinstate' : 'IN_PULLDOWN' }, # 'P0_26' -  Pin negated in software
  'BT_LED' : { 'pin' : 'D23' }, # Pin negated in software
  'WIFI_LED' : { 'pin' : 'D2' }, # Pin negated in software
  'NTP_LED' : { 'pin' : 'D15' }, # Pin negated in software
  'IOT_LED' : { 'pin' : 'D12' }, # Pin negated in 
};
